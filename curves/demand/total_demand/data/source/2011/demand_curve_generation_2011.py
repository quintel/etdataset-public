...
for l in range(0,len(countries)):
    ...
    for i in range(1,13):
        ...
        f = open(curpath + '/data/ENTSO-E/' + str(i) +'-2011.csv')
...
# Add all EU demand curves and export profile
output = zeros((8760))
...
# Export EU profile
savetxt(curpath + '/data/demand_curves/' + 'EU' + '_demand_curve.csv', output, fmt="%d", delimiter =',')
