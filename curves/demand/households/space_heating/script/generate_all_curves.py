...
EU_27 = ['AT_austria', 'BE_belgium', 'BG_bulgaria', 'CY_cyprus', 'CZ_czechia', 'DE_germany',
    'DK_denmark', 'EE_estonia', 'ES_spain', 'FI_finland', 'FR_france',
    'EL_greece', 'HR_croatia', 'HU_hungary', 'IE_ireland', 'IT_italy', 'LT_lithuania',
    'LU_luxembourg', 'LV_latvia', 'MT_malta', 'NL_netherlands', 'PL_poland', 'PT_portugal', 
    'RO_romania', 'SE_sweden', 'SI_slovenia', 'SK_slovakia']

EU_28 = ['AT_austria', 'BE_belgium', 'BG_bulgaria', 'CY_cyprus', 'CZ_czechia', 'DE_germany',
    'DK_denmark', 'EE_estonia', 'ES_spain', 'FI_finland', 'FR_france',
    'EL_greece', 'HR_croatia', 'HU_hungary', 'IE_ireland', 'IT_italy', 'LT_lithuania',
    'LU_luxembourg', 'LV_latvia', 'MT_malta', 'NL_netherlands', 'PL_poland', 'PT_portugal',
    'RO_romania', 'SE_sweden', 'SI_slovenia', 'SK_slovakia', 'UK_united_kingdom']
...
for country in countries:
    ...
    for curve in generate_profiles(temp, irradiation, thermostat):
