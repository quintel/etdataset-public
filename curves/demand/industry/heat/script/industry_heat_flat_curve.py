...
# Write data to file
np.savetxt(output_file_path + "industry_heat" + ".csv", hourly_data, fmt='%.10e', delimiter=',')

print("Succesfully written output files industry_heat.csv " + str(country) + " " + str(year) + "!")
