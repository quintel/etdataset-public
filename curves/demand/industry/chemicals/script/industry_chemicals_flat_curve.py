...
np.savetxt(output_path / "industry_chemicals.csv", hourly_data, fmt='%.10e', delimiter=',')

print("Succesfully written output files industry_chemicals.csv " + str(country) + " " + str(year) + "!")
