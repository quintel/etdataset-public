...
for l in range(0,len(countries)):
    ...
    for i in range(1,13):
        ...
        f = open(curpath + '/data/ENTSO-E/' + str(i) +'-2013.csv')
    ...
    output.pop(7230)# Oct 28 is n.a.
                    # Oct 27 contains the extra hour, and is therefore not 'n.a.'
    ...
    output.pop(2138)# daylight saving switch in March (one hour 'does not exist')
